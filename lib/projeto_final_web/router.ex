defmodule ProjetoFinalWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {ProjetoFinalWeb.Layouts, :root}
  ...
  scope "/", ProjetoFinalWeb do
    pipe_through :browser

    get "/", PageController, :index
    resources "/personagens", PersonagemController
    resources "/feiticos", FeiticoController
  end
